        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              <div className="rule-section mb-8">
                <h3 className="text-2xl font-bold text-red-400 mb-4">
                  {t('lore.deathwatch.grimDarkness')}
                </h3>
                <div className="stat-block">
                  <p className="text-gray-300 leading-relaxed">
                    {t('lore.deathwatch.grimDarknessText')}
                  </p>
                </div>
              </div>
              ...
              <div className="rule-section mb-8">
                <h3 className="text-2xl font-bold text-red-400 mb-4">
                  {t('lore.deathwatch.sacredDuty')}
                </h3>
                <div className="stat-block">
                  <p className="text-gray-300 leading-relaxed">
                    {t('lore.deathwatch.sacredDutyText')}
                  </p>
                </div>
              </div>
              ...
              <div className="rule-section mb-8">
                <h3 className="text-2xl font-bold text-red-400 mb-4">
                  {t('lore.deathwatch.killTeams')}
                </h3>
                <div className="stat-block">
                  <p className="text-gray-300 leading-relaxed">
                    {t('lore.deathwatch.killTeamsText')}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="rule-section mb-8">
                <h3 className="text-2xl font-bold text-red-400 mb-4">
                  {t('lore.deathwatch.alienThreat')}
                </h3>
                <div className="stat-block">
                  <p className="text-gray-300 leading-relaxed">
                    {t('lore.deathwatch.alienThreatText')}
                  </p>
                </div>
              </div>
              ...
              <div className="rule-section mb-8">
                <h3 className="text-2xl font-bold text-red-400 mb-4">
                  {t('lore.deathwatch.priceVigilance')}
                </h3>
                <div className="stat-block">
                  <p className="text-gray-300 leading-relaxed">
                    {t('lore.deathwatch.priceVigilanceText')}
                  </p>
                </div>
              </div>
            </div>
